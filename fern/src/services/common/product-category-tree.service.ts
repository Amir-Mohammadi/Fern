...
import { IProductCategoriesTree, ProductCategoriesTreeCache } from '@Services/adaptor/product-categories-adaptor';
import hash from 'object-hash';
import localStorageService, { LocalStorageKeys } from './local-storage.service';

class ProductCategoryTreeService {
  public transformMarketProductCategoryListToTree(
  ...
  private _productCategoriesArrayToTree(
    productCategories: Array<MarketProductCategoryModel>,
  ): IProductCategoriesTree[] {
...
// singleton
const productCategoryTreeService = new ProductCategoryTreeService();
export default productCategoryTreeService;
